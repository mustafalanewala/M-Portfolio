...
const projectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    description:
      "A video design for ExoVanguard Prime, featuring dynamic motion graphics and visual storytelling.",
    image: "ExoVanguard.png",
    gif: "ExoVanguard Prime.gif",
    category: "design",
    technologies: ["Figma"],
    liveUrl:
      "https://www.figma.com/community/file/1442829907230346002/exovanguard-prime",
    githubUrl: undefined,
  },
  {
    id: "p-2",
  ...
  },
  {
    ...
    title: "Smoothie Bowl",
    description:
      "A video design showcasing a Smoothie Bowl, emphasizing smooth transitions and appealing visuals for culinary presentation.",
    image: "SmoothieBowl.png",
    gif: "SmoothieBowl.gif",
    category: "design",
    technologies: ["Figma"],
    liveUrl:
      "https://www.figma.com/community/file/1445708163811090992/smoothie-bowl",
    githubUrl: undefined,
  },
  {
    id: "p-4",
  ...
  },
  {
    ...
    title: "BentoGrid",
    description:
      "A design showcasing modern BentoGrid, emphasizing clean and minimalist aesthetics.",
    image: "BentoGrid.png",
    gif: undefined,
    category: "design",
    technologies: ["Figma"],
    liveUrl:
      "https://www.figma.com/community/file/1445708163811090992/bentogrid",
    githubUrl: undefined,
  },
  {
    id: "p-5",
    title: "Elysium",
    description:
      "Elysium is a Wallpaper App that offers high-quality wallpapers free of cost.",
    image: "Elysium.png",
    gif: undefined,
    category: "project",
  ...
  },
  {
    ...
    title: "MWatch",
    description:
      "An image-based design for MWatch, focusing on the user interface and aesthetic of a modern smartwatch.",
    image: "MWatch.png",
    gif: undefined,
    category: "design",
    technologies: ["Figma"],
  ...
  },
  {
    ...
    title: "AetherX",
    description:
      "An image-based design for AetherX, focusing on futuristic interfaces and detailed static elements.",
    image: "AetherX.png",
    gif: undefined,
    category: "design",
    technologies: ["Figma"],
  ...
  },
  {
    ...
    description:
      "An image-based design for Ethereal Essence, conveying refined beauty through minimalist aesthetics.",
    image: "EtherealEssence.png",
    gif: undefined,
    category: "design",
    technologies: ["Figma"],
    liveUrl:
      "https://www.figma.com/community/file/1440988996373788204/ethereal-essence",
    githubUrl: undefined,
  },
  {
    id: "p-3",
  ...
  },
  {
    ...
    description:
      "A video design showcasing an Ice Cream Transition, using animation for smooth and delightful visual effects.",
    image: "IceCream.png",
    gif: "IceCream.gif",
    category: "design",
    technologies: ["Figma"],
    liveUrl:
      "https://www.figma.com/community/file/1442039011845968196/ice-cream-transition",
    githubUrl: undefined,
  },
  {
    id: "d-6",
    title: "Balenciaga",
    description:
      "A video design for Balenciaga, capturing luxury and modern aesthetics through sleek motion.",
    image: "Balenciaga.png",
    gif: "Balenciaga.gif",
    category: "design",
    technologies: ["Figma"],
    liveUrl:
      "https://www.figma.com/community/file/1443919596373788204/balenciaga",
    githubUrl: undefined,
  },
]
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          <div className="flex gap-2">
            ...
            >
              Projects (
              {projectsData.filter((p) => p.category === "project").length})
            </Button>
            <Button
