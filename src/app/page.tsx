...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-black p-2 sm:p-3 md:p-4 lg:p-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 md:gap-4 lg:gap-4">
        ...
        <Card className="bg-gray-900 border-gray-800 text-white sm:col-span-2 lg:col-span-1">
          <CardContent className="p-3 sm:p-4 lg:p-6 h-full flex flex-col">
            <div className="flex flex-col sm:flex-row items-start gap-3 mb-4">
              <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-28 lg:h-28 rounded-full overflow-hidden bg-blue-200 flex-shrink-0 mx-auto sm:mx-0 border-2 border-purple-500/50">
                <Image
                  src="/avatar.jpg"
              ...
              <div className="text-center sm:text-left">
                <div className="text-lg sm:text-xl lg:text-2xl mb-1">🤖 {"Hie! I'm"}</div>
                <h1 className="text-lg sm:text-xl lg:text-2xl font-bold mb-1">Mustafa Lanewala</h1>
                <p className="text-gray-400 text-xs sm:text-sm lg:text-base">AI & Full Stack Engineer</p>
              </div>
            </div>
            ...
            <div className="flex justify-center sm:justify-start items-start gap-2 mb-6">
              <Button
                size="icon"
                variant="ghost"
                className="w-6 h-6 sm:w-10 sm:h-10 rounded-full bg-purple-800/50 hover:bg-gradient-to-r hover:from-[#E1306C]/70 hover:to-[#FCAF45]/70 hover:scale-110 hover:shadow-lg transition-all duration-300"
              >
              ...
              <Button
                size="icon"
                variant="ghost"
                className="w-6 h-6 sm:w-10 sm:h-10 rounded-full bg-purple-800/50 hover:bg-gradient-to-r hover:from-[#0A66C2]/70 hover:to-[#33C4FF]/70 hover:scale-110 hover:shadow-lg transition-all duration-300"
              >
              ...
              <Button
                size="icon"
                variant="ghost"
                className="w-6 h-6 sm:w-10 sm:h-10 rounded-full bg-purple-800/50 hover:bg-gradient-to-r hover:from-[#181717]/70 hover:to-[#4B4B4B]/70 hover:scale-110 hover:shadow-lg transition-all duration-300"
              >
              ...
              <Button
                size="icon"
                variant="ghost"
                className="w-6 h-6 sm:w-10 sm:h-10 rounded-full bg-purple-800/50 hover:bg-gradient-to-r hover:from-[#EA4335]/70 hover:to-[#F28B82]/70 hover:scale-110 hover:shadow-lg transition-all duration-300"
              >
        ...
        <Card className="bg-gray-900 border-gray-800 text-white sm:col-span-2 lg:col-span-1 h-full overflow-hidden">
          <CardContent className="p-3 sm:p-4 lg:p-6 h-full flex flex-col">
            <div className="flex items-center gap-2 mb-3">
              <h2 className="text-sm sm:text-lg lg:text-xl font-bold">📧 Contact Me</h2>
            </div>
        ...
        <Card className="bg-gradient-to-br from-purple-900 via-gray-900 to-blue-900 border-purple-500/30 text-white sm:col-span-2 h-full overflow-hidden">
          <CardContent className="p-3 sm:p-4 lg:p-6 h-full flex flex-col">
            <div className="flex items-center gap-2 mb-3">
              <h2 className="text-sm sm:text-lg lg:text-xl font-bold">🧠 AI Assistant</h2>
              ...
              <form onSubmit={handleSubmit} className="flex gap-2">
                <div className="relative flex-1">
                  <Input
                    ...
                    className="bg-black/30 border-purple-500/30 text-white placeholder:text-gray-400 text-xs sm:text-sm h-8 sm:h-9"
                    disabled={isLoading}
                  />
                ...
                <Button
                  type="submit"
                  size="icon"
                  className="bg-purple-600 hover:bg-purple-700 hover:scale-110 transition-all duration-300 w-8 h-8 sm:w-9 sm:h-9"
